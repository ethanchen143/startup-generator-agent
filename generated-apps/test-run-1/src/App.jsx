      ...
      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '1.5rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <span className="tag">Automated Compliance & Telemetry for Remote Health Tech</span>
          </div>
          <p style={{ color: '#94a3b8', marginTop: '0.5rem', fontSize: '1.05rem' }}>Next-Generation Autonomous Engine for Automated Compliance & Telemetry for Remote Health Tech</p>
        </div>
